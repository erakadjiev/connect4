...
public class Connect4 {
	...
	public void play() {
		...
		while (!board.isFull() || board.isWon()) {
			...
			while (!validMove) {
				System.out.print("Player " + currentPlayerId + " [" + currentPlayer.getName() + "] - choose column (1-" + Board.COLS + "): ");
			...
			if (board.isWon()) {
				System.out.println("Player " + currentPlayerId + " [" + currentPlayer.getName() + "] wins!");
				break;
			}
